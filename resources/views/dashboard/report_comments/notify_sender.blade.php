...
<div class="modal fade" id="notify_sender{{ $reportComment->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('report_ads.notify', $reportComment->comment->user->id) }}" method="POST">
                ...
                <div class="modal-body" style="text-align: center">
                    <h3>{{ __('admin_dashboard/report/messages.Reply to the report') }} <span style="color: red">{{ $reportComment->sender->name }}</span></h3>
                </div>
