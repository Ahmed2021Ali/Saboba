            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="scrollable">
                        ...
                        <img class="mySlides" src="{{$verification->user->getFirstMediaUrl('userImages')}}" alt="company Image" width="150" height="100">
                        @else
                            <img class="mySlides" src="https://marketplace.canva.com/EAE0rNNM2Fg/1/0/1600w/canva-letter-c-trade-marketing-logo-design-template-r9VFYrbB35Y.jpg" alt="company Image" width="150" height="100">
                        @endif
