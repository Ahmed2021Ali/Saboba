                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="password_confirmation"><strong>تأكيد كلمة
                                                    المرور:</strong></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="country_id"><strong>اختر دولة  :</strong></label>
                                            <select name="country_id" id="country_id" class="form-control" required>
                                                <option style="display: none"> اختر دولة المستخدم </option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label for="type"><strong>النوع :</strong></label>
                                            <select name="type" id="type" class="form-control">
                                                <option style="display: none"> اختر نوع المستخدم </option>
                                                <option value="admin"> ادمن</option>
                                                <option value="personal"> مستخدم</option>
